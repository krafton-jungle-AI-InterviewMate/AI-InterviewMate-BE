...
public enum StatusCode {
    ...
    NOT_FOUND_QUESTION_TITLE(HttpStatus.BAD_REQUEST, "105", "질문 제목이 존재하지 않거나 공백입니다."),
    NOT_FOUND_QUESTION_BOX_TITLE(HttpStatus.BAD_REQUEST, "106", "질문 꾸러미 제목이 존재하지 않거나 공백입니다."),
